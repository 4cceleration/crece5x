                ...
                return (
                  <td key={c.key} className="p-0">
                    {isAvailable ? (
                      <Link
                        href={hrefFor(c.key)}
                        className="flex aspect-square items-center justify-center rounded-md bg-brand-soft font-semibold text-brand-strong ring-1 ring-brand/30 transition-[background-color,color,scale] duration-base ease-spring hover:scale-105 hover:bg-brand-strong hover:text-on-accent active:scale-95"
                      >
                        {c.day}
                      </Link>
                    ) : (
