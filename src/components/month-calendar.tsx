                ...
                return (
                  <td key={c.key} className="p-0">
                    {isAvailable ? (
                      <Link
                        href={hrefFor(c.key)}
                        className="flex aspect-square items-center justify-center rounded-md bg-brand-soft font-semibold text-brand-deep ring-1 ring-brand/30 transition-[background-color,color] hover:bg-brand-strong hover:text-white"
                      >
                        {c.day}
                      </Link>
                    ) : (
